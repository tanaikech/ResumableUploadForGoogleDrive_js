 ...
 *
 * [Offical Doc - Update](https://developers.google.com/drive/api/reference/rest/v3/files/update)
 *  [uploads Types](https://developers.google.com/drive/api/guides/manage-uploads)
 */
 (function (r) {
  ...
  ResumableUploadToGoogleDrive2 = (function () {
    ...
    const init = function (resource) {
      return new Promise((resolve, reject) => {
        ...
        // file id for content updating
        if ("fileId" in resource && resource.fileId != "") {
          this.endpoint += "/" + encodeURIComponent(resource.fileId);
        }

        // adding resumable type
        //  must after fileId
        this.endpoint += "?uploadType=resumable";
    ...
    const getLocation = function () {
      return new Promise((resolve, reject) => {
        ...
        if ("folderId" in resource && resource.folderId != "") {
          metadata.addParents = [resource.folderId];
        }
        console.log("PATCH 1 ");
        fetch(this.endpoint, {
          method: "PATCH",
